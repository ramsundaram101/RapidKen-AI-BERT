...
1. Use these files in the zip file and install `pytorch-pretrained-BERT`
...
3. Change the parameters accordingly in `experiments/base_model/params.json`. We recommend keeping batch size of 4 and sequence length of 512, with 2 epochs, if GPU's VRAM is around 11 GB.
...
### Subtask 1: Mentions Identification
